#ifndef AnalitikaArtikliLISTA_H
#define AnalitikaArtikliLISTA_H
...
namespace Ui {
class AnalitikaArtikliLista;
}

class AnalitikaArtikliLista : public BaseForm
{
    Q_OBJECT

public:
    explicit AnalitikaArtikliLista(BaseForm *parent = 0);
    ...
    AnalitikaArtikli_trans getFakturaData();
...
private:
    ...
    QBTemplate<AnalitikaArtikliDetailT> *bc;

    QItemSelectionModel *sm;

    QList<AnalitikaArtikliT> resFakturaTemp;
    AnalitikaArtikliT currentData;
    QList<AnalitikaArtikliDetailT> resFakturaDetailTemp;
    QString str_yellow;
    QString str_none;
    bool enableClose;
protected:
