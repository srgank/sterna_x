#ifndef AnalitikaKomintentiKOREKCIJA_H
#define AnalitikaKomintentiKOREKCIJA_H
...
namespace Ui {
class AnalitikaKomintentiKorekcija;
}

class AnalitikaKomintentiKorekcija : public BaseForm
{
    Q_OBJECT

public:
    explicit AnalitikaKomintentiKorekcija(BaseForm *parent = 0);
    ~AnalitikaKomintentiKorekcija();
...
private:
    Ui::AnalitikaKomintentiKorekcija *ui;
    ...
    QList<AnalitikaKomintentiDetailT> resFakturaItems_oldData;\
...
#endif // AnalitikaKomintentiKOREKCIJA_H
