...
#include "ui_int_priemnicakorekcija.h"

IntPriemniciKorekcija::IntPriemniciKorekcija(BaseForm *parent) :
    BaseForm(parent),
    statusWait(false),
    hlp(0),
    statusOpenEditor(false),
    ui(new Ui::IntPriemniciKorekcija)
{
    ui->setupUi(this);
    ...
    b = new QBTemplate<IntPriemniciT>();
    bd = new QBTemplate<IntPriemniciDetailT>();
...
IntPriemniciKorekcija::~IntPriemniciKorekcija()
{
    Singleton *s = Singleton::Instance();
...
void IntPriemniciKorekcija::pressEscape()
{
    emit signalpressEscape();
}

void IntPriemniciKorekcija::setFocusArtikal(artikalT t)
{
    ui->artikal->setFocus();
...
void IntPriemniciKorekcija::setFocusKomintent(komintentT t)
{
...
void IntPriemniciKorekcija::pressReturn()
{
...
void IntPriemniciKorekcija::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void IntPriemniciKorekcija::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    table->closePersistentEditor(index);
}


void IntPriemniciKorekcija::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    m_index = modelX;
    m_row = modelX.row();
}
...
void IntPriemniciKorekcija::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void IntPriemniciKorekcija::initProc(IntPriemnici_trans m_data)
{
...
void IntPriemniciKorekcija::procDeleteItem(){
    QList<IntPriemniciDetailT> data = resFakturaItems;
    bd->RemoveItem(data, m_row);
    resFakturaItems = data;
}

bool IntPriemniciKorekcija::procAddItem(){

    QList<IntPriemniciDetailT> data = resFakturaItems;
    IntPriemniciDetailT item;
...
void IntPriemniciKorekcija::on_pushButton_6_clicked()
{
    PressKeyReturn(this);
}


void IntPriemniciKorekcija::on_pushButton_3_clicked()
{
    PressKeyReturn(this);
}

void IntPriemniciKorekcija::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void IntPriemniciKorekcija::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void IntPriemniciKorekcija::on_pushButton_4_clicked()
{
    // update faktura
    resFaktura.dokument_tip = "20";
    QList<dokumentT> dok;
    QList<IntPriemniciT> IntPriemniciList;
    IntPriemniciList.append(resFaktura);

    b->ConvertAnyToDokument(IntPriemniciList, dok);
...
bool IntPriemniciKorekcija::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
...
void IntPriemniciKorekcija::Refresh()
{
    updateFont();
}
