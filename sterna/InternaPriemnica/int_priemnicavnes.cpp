...
#include "ui_int_priemnicavnes.h"

IntPriemniciVnes::IntPriemniciVnes(BaseForm *parent) :
    BaseForm(parent),
    statusWait(false),
    hlp(0),
    statusOpenEditor(false),
    ui(new Ui::IntPriemniciVnes)
{
    ui->setupUi(this);
...
IntPriemniciVnes::~IntPriemniciVnes()
{
    Singleton *s = Singleton::Instance();
...
void IntPriemniciVnes::pressEscape()
{
...
void IntPriemniciVnes::on_pushButton_released()
{
...
void IntPriemniciVnes::setFocusArtikal(artikalT t)
{
    ui->artikal->setFocus();
...
void IntPriemniciVnes::setFocusKomintent(komintentT t)
{
...
void IntPriemniciVnes::pressReturn()
{
...
void IntPriemniciVnes::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void IntPriemniciVnes::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    table->closePersistentEditor(index);
}

void IntPriemniciVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    m_index = modelX;
    m_row = modelX.row();
}

void IntPriemniciVnes::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void IntPriemniciVnes::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void IntPriemniciVnes::initProc(IntPriemnici_trans m_data)
{
    resFakturaItems = m_data.data2;
    showData();
}

void IntPriemniciVnes::procDeleteItem(){
    QList<IntPriemniciDetailT> data = resFakturaItems;
    bd->RemoveItem(data, m_row);
    resFakturaItems = data;
}

bool IntPriemniciVnes::procAddItem(){
    QList<IntPriemniciDetailT> data = resFakturaItems;
...
void IntPriemniciVnes::showData(){
...
void IntPriemniciVnes::on_pushButton_6_clicked()
{
    PressKeyReturn(this);
}


void IntPriemniciVnes::on_pushButton_3_clicked()
{
    PressKeyReturn(this);
}

void IntPriemniciVnes::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void IntPriemniciVnes::on_pushButton_4_clicked()
{
...
bool IntPriemniciVnes::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
