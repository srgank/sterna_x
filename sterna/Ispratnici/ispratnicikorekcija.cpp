    ...
    ui(new Ui::IspratniciKorekcija)
{
    ...
    bd = new QBTemplate<IspratniciDetailT>();
...
void IspratniciKorekcija::setFocusKomintent(komintentT t)
{
...
void IspratniciKorekcija::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void IspratniciKorekcija::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
...
void IspratniciKorekcija::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void IspratniciKorekcija::initProc(Ispratnici_trans m_data)
{
...
void IspratniciKorekcija::procDeleteItem(){
    QList<IspratniciDetailT> data = resFakturaItems;
    bd->RemoveItem(data, m_row);
    resFakturaItems = data;
}

bool IspratniciKorekcija::procAddItem(){

    QList<IspratniciDetailT> data = resFakturaItems;
    IspratniciDetailT item;
...
void IspratniciKorekcija::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void IspratniciKorekcija::on_pushButton_4_clicked()
{
    // update faktura
    resFaktura.dokument_tip = "20";
    QList<dokumentT> dok;
    QList<IspratniciT> IspratniciList;
    IspratniciList.append(resFaktura);

    b->ConvertAnyToDokument(IspratniciList, dok);
...
bool IspratniciKorekcija::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
...
void IspratniciKorekcija::Refresh()
{
    updateFont();
}
