...
void IspratniciVnes::setFocusKomintent(komintentT t)
{
...
void IspratniciVnes::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void IspratniciVnes::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
...
void IspratniciVnes::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void IspratniciVnes::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void IspratniciVnes::initProc(Ispratnici_trans m_data)
{
...
bool IspratniciVnes::procAddItem(){
    QList<IspratniciDetailT> data = resFakturaItems;
...
void IspratniciVnes::on_pushButton_4_clicked()
{
...
bool IspratniciVnes::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
