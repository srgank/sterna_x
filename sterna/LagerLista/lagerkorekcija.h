#ifndef LagerKOREKCIJA_H
#define LagerKOREKCIJA_H
...
namespace Ui {
class LagerKorekcija;
}

class LagerKorekcija : public BaseForm
{
    Q_OBJECT

public:
    explicit LagerKorekcija(BaseForm *parent = 0);
    ~LagerKorekcija();
    virtual void pressEscape();
    virtual void pressReturn();
    virtual void updateFont();
    virtual void Refresh();
    void initProc(Lager_trans m_data);
    void setFocusArtikal(artikalT t);
    void setFocusKomintent(komintentT t);

private:
    Ui::LagerKorekcija *ui;
    ...
    bool statusWait;
    QBTemplate<LagerT> *b;
    QBTemplate<LagerDetailT> *bd;
    LagerT resFaktura;
    QList<LagerDetailT> resFakturaItems;\
    QList<LagerDetailT> resFakturaItems_oldData;\
