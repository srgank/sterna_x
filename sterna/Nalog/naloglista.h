...
class NalogLista : public BaseForm
{
    Q_OBJECT

public:
    explicit NalogLista(BaseForm *parent = 0);
    ~NalogLista();
...
private:
    ...
    QBTemplate<NalogDetailT> *bc;

    QItemSelectionModel *sm;

    QList<NalogT> resFakturaTemp;
    NalogT currentData;
    QList<NalogDetailT> resFakturaDetailTemp;
    QString str_yellow;
    QString str_none;
    bool enableClose;
protected:
