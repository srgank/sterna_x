...
void NarackiVnes::on_pushButton_released()
{
...
void NarackiVnes::setFocusArtikal(artikalT t)
{
    ui->artikal->setFocus();
...
void NarackiVnes::setFocusKomintent(komintentT t)
{
...
void NarackiVnes::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void NarackiVnes::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    table->closePersistentEditor(index);
}

void NarackiVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    m_index = modelX;
    m_row = modelX.row();
}

void NarackiVnes::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void NarackiVnes::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void NarackiVnes::on_pushButton_6_clicked()
{
    PressKeyReturn(this);
}


void NarackiVnes::on_pushButton_3_clicked()
{
    PressKeyReturn(this);
}

void NarackiVnes::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void NarackiVnes::on_pushButton_4_clicked()
{
...
bool NarackiVnes::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
