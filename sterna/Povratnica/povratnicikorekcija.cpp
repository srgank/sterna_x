...
#include "ui_povratnicikorekcija.h"
...
void PovratniciKorekcija::setFocusArtikal(artikalT t)
{
    ui->artikal->setFocus();
...
void PovratniciKorekcija::setFocusKomintent(komintentT t)
{
...
void PovratniciKorekcija::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void PovratniciKorekcija::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    table->closePersistentEditor(index);
}


void PovratniciKorekcija::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    m_index = modelX;
    m_row = modelX.row();
}
...
void PovratniciKorekcija::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void PovratniciKorekcija::procDeleteItem(){
...
void PovratniciKorekcija::showData(){
    QList<PovratniciDetailT> data = resFakturaItems;
...
void PovratniciKorekcija::on_pushButton_6_clicked()
{
    PressKeyReturn(this);
}


void PovratniciKorekcija::on_pushButton_3_clicked()
{
    PressKeyReturn(this);
}

void PovratniciKorekcija::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void PovratniciKorekcija::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
bool PovratniciKorekcija::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
...
void PovratniciKorekcija::Refresh()
{
    updateFont();
}
