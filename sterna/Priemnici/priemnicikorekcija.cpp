...
void PriemniciKorekcija::setFocusKomintent(komintentT t)
{
...
void PriemniciKorekcija::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void PriemniciKorekcija::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    table->closePersistentEditor(index);
}


void PriemniciKorekcija::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    m_index = modelX;
    m_row = modelX.row();
}
...
void PriemniciKorekcija::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void PriemniciKorekcija::initProc(Priemnici_trans m_data)
{
...
void PriemniciKorekcija::showData(){
    QList<PriemniciDetailT> data = resFakturaItems;
...
void PriemniciKorekcija::on_pushButton_6_clicked()
{
    PressKeyReturn(this);
}


void PriemniciKorekcija::on_pushButton_3_clicked()
{
    PressKeyReturn(this);
}

void PriemniciKorekcija::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void PriemniciKorekcija::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void PriemniciKorekcija::on_pushButton_4_clicked()
{
    // update faktura
...
void PriemniciKorekcija::Refresh()
{
    updateFont();
}
