  ...
  , enableClose(true)
{
    ...
    bc = new QBTemplate<PriemniciDetailT>();
...
void PriemniciLista::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    ...
    QList<PriemniciDetailT> resFakturaDetail;
    ...
    QList<PriemniciDetailT> data = resFakturaDetail;
...
void PriemniciLista::initProc(int searchIDList, QString& searchStrList, int searchOffsetList)
{
...
Priemnici_trans PriemniciLista::getFakturaData(){
    Priemnici_trans temp;
    temp.data1 = currentData;
    temp.data2 = resFakturaDetailTemp;
    return temp;
}
void PriemniciLista::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void PriemniciLista::on_prebaruvanje_po_komintent_textChanged(const QString &arg1)
{
    on_lineEdit_textChanged(arg1);
}

bool PriemniciLista::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
