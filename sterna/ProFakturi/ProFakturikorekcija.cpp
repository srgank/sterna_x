    ...
    ui(new Ui::ProFakturiKorekcija)
{
    ...
    bd = new QBTemplate<ProFakturiDetailT>();
...
void ProFakturiKorekcija::setFocusKomintent(komintentT t)
{
...
void ProFakturiKorekcija::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void ProFakturiKorekcija::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
...
void ProFakturiKorekcija::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
bool ProFakturiKorekcija::procAddItem(){
...
void ProFakturiKorekcija::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void ProFakturiKorekcija::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void ProFakturiKorekcija::on_pushButton_4_clicked()
{
    // update faktura
    resFaktura.dokument_tip = "20";
    QList<dokumentT> dok;
    QList<ProFakturiT> ProFakturiList;
    ProFakturiList.append(resFaktura);

    b->ConvertAnyToDokument(ProFakturiList, dok);
...
bool ProFakturiKorekcija::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
...
void ProFakturiKorekcija::Refresh()
{
    updateFont();
}
