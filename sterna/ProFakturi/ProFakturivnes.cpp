...
void ProFakturiVnes::setFocusKomintent(komintentT t)
{
...
void ProFakturiVnes::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void ProFakturiVnes::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
...
void ProFakturiVnes::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void ProFakturiVnes::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
bool ProFakturiVnes::procAddItem(){
    QList<ProFakturiDetailT> data = resFakturaItems;
...
void ProFakturiVnes::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void ProFakturiVnes::on_pushButton_4_clicked()
{
...
bool ProFakturiVnes::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
