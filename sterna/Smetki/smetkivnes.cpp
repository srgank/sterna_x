...
void SmetkiVnes::on_pushButton_released()
{
...
void SmetkiVnes::setFocusKomintent(komintentT t)
{
...
void SmetkiVnes::OpenTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    switch (index.column()){
...
void SmetkiVnes::CloseTablePersistentEditor(QTableView * table, QModelIndex &index)
{
    table->closePersistentEditor(index);
}

void SmetkiVnes::selectionChanged(QModelIndex modelX,QModelIndex modelY)
{
    m_index = modelX;
    m_row = modelX.row();
}

void SmetkiVnes::selectionChangedDetail(QModelIndex modelX,QModelIndex modelY)
{
    if (modelX != modelY){
        CloseTablePersistentEditor(ui->tableView, m_index);
    }
...
void SmetkiVnes::updateStructCellLineEdit(const QModelIndex & index, QString & value)
{
    switch (index.column()){
...
void SmetkiVnes::on_pushButton_6_clicked()
{
    PressKeyReturn(this);
}


void SmetkiVnes::on_pushButton_3_clicked()
{
    PressKeyReturn(this);
}

void SmetkiVnes::updateFont()
{
    Singleton *s = Singleton::Instance();
...
void SmetkiVnes::on_pushButton_4_clicked()
{
...
bool SmetkiVnes::eventFilter(QObject *object, QEvent *event)
{
    Singleton *s = Singleton::Instance();
